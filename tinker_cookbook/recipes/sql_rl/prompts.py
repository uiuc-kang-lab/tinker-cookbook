...
- You can use the SQL tool to explore data or verify result. Call SQL tool: {tool_calling}. You will receive the execution results or error information of the SQL from a user. Based on this information, you can think again and refine. You can only call the SQL tool once at a time.
...
qwen_tool_calling = """<function_call>{"name": "sql", "args": {"query": "your sql query"}}</function_call>"""

general_tool_calling = """<sql>your sql query</sql>"""
